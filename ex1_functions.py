...
def run_graphic(n, pedestrian_number,obstacle_number,grid_size, env,X,target,speed,waiting_list,persistance) : 
    ...
    def leftclick(event):
        ...
        X,waiting_list = one_step(env,pedestrian_number,X,speed,waiting_list,grid_size,target) 
...
def one_step(env,pedestrian_number,X, speed, waiting_list,grid_size,target) :
